...
HD_PWD='/tmp/tmp.vsB2ccuvX3/temp/hwflow/hwflow_project_1/project_1.runs/project_1_zynq_7000_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_1_zynq_7000_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_1_zynq_7000_0_0.tcl
